...
<body>
	...
	<main>
		<br>
		<h1 id="qdash" align="center">My Questions</h1>
		<?php
		$uid = $_SESSION[ 'usernID' ];
		$sql = "select distinct * from question WHERE question_user_id=$uid";
		...
		if ($num==0)
		{
			echo "<br><br><h2 align='center' style='color: white'>You have no question right now.</h2>"; 
			...
			while ( $row = mysqli_fetch_array( $query, MYSQLI_ASSOC ) ) {
				...
				echo "<a href='../php/questionDetails.php?QID=$QID' class='ques'>$question</a><br><br>
				      <a href='../php/deleteQuestion.php?QID=$QID' class='delete'>Delete</a><br>";
				echo "</div><br><br><br>";
			}
		}
		?>
